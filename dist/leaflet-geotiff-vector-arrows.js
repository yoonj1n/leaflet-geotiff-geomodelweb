  ...
  L.LeafletGeotiff.VectorArrows = L.LeafletGeotiffRenderer.extend({
    ...
    render: function (raster, canvas, ctx, args) {
      ...
      var gradientColors = [
        ...
        { value: 0.20, color: '#2AD8FE' },
        { value: 0.30, color: '#4AB8FE' },
        { value: 0.40, color: '#91D587' },
        { value: 0.60, color: '#E2F700' },
        { value: 0.80, color: '#E6D400' },
        { value: 1.00, color: '#EAB500' },
        { value: 1.20, color: '#EE9000' },
        { value: 1.40, color: '#F26F00' },
