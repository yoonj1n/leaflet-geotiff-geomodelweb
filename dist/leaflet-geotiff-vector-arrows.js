(function (factory) {
  ...
  L.LeafletGeotiff.VectorArrows = L.LeafletGeotiffRenderer.extend({
    ...
    render: function (raster, canvas, ctx, args) {
      ...
      var gradientColors = [
        { value: 0.00, color: '#07FCFF' },
        { value: 0.20, color: '#2DD6FE' },
        { value: 0.40, color: '#4AB8FE' },
        { value: 0.60, color: '#56ACFE' },
        { value: 0.80, color: '#6B96FE' },
        { value: 1.00, color: '#857CFE' },
        { value: 1.20, color: '#A35EFE' },
        { value: 1.40, color: '#BB45FE' },
        { value: 1.60, color: '#D62AFE' },
        { value: 1.80, color: '#E917FE' },
        { value: 2.00, color: '#FE01FE' },
